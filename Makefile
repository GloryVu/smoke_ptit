...
run: local-trt
	docker run --gpus=all --shm-size 8GB --rm --publish=12009:5000 --volume=/home/iec-ptit/Desktop/vvinh/frigate_dev/frigate-0.12.1/config:/config --volume=/home/iec-ptit/Desktop/vvinh/frigate_dev/frigate-0.12.1/debug:/media/frigate frigate:latest-tensorrt
