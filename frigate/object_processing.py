...
class TrackedObject:
    ...
    def _is_false_positive(self):
        ...
        if not self.false_positive:
            return False
        print(self.obj_data["label"])
        print(self.camera_config.objects.filters[self.obj_data["label"]].threshold)
    ...
    def to_dict(self, include_thumbnail: bool = False):
        ...
        event = {
            ...
            "mm_mmb": str(self.obj_data['mm_mmb']),
        }
    ...
    def get_jpg_bytes(
        ...
        if bounding_box:
            ...
            draw_box_with_label(
                ...
                box[3],
                self.obj_data["label"],
                f"{int(self.thumbnail_data['score']*100)}%  {self.obj_data['mm_mmb']}", #{int(self.thumbnail_data['area'])}
                thickness=thickness,
                color=color,
            )
        ...
        if draw_options.get("bounding_boxes"):
            ...
            for obj in tracked_objects.values():
                ...
                draw_box_with_label(
                    ...
                    box[3],
                    obj["label"],
                    f"{obj['score']:.0%} {obj['mm_mmb']}", #{int(obj['area'])} 
                    thickness=thickness,
                    color=color,
                )
